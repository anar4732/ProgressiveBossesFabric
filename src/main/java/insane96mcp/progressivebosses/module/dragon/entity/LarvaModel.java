...
public class LarvaModel<T extends Entity> extends HierarchicalModel<T> {
	...
	private final net.minecraft.client.model.geom.ModelPart[] bodyParts;

	public LarvaModel(net.minecraft.client.model.geom.ModelPart part) {
		this.root = part;
		this.bodyParts = new net.minecraft.client.model.geom.ModelPart[4];
