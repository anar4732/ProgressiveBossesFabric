...
public class WitherMinionRenderer extends HumanoidMobRenderer<WitherMinion, WitherMinionModel<WitherMinion>> {
	private static final ResourceLocation MINION_TEXTURES = new ResourceLocation(ProgressiveBosses.MODID, "textures/entity/wither_minion.png");
	 ...
	 */
	public ResourceLocation getTexture(WitherMinion entity) {
